...
public class ProductDaoTest {
    ...
    public void findbyId_test() {
        ...
        // when (테스트)
        Product productPS = productDao.findById(productId); // 영속화된 데이터이기때문에 PS붙이면 좋음
    ...
    // Junit은 메서드 실행 직전에 트랜잭션이 걸리고, 메서드 실행이 끝나면 rollback 된다.
    // MyBatis는 ResultSet을 자바 Entity로 변경해줄 때, 빈 생성자 + setter, 풀 생성자를 호출하고,
    // setter가 없어도 값을 매핑해준다.
    @Test
